...
//  SteeringMode = 0;
//  Left_Init(12500, 100,1);          // initialize PWM0, 100 Hz
//  Right_InitB(12500, 100,1);   // initialize PWM0, 100 Hz
//  Servo_Init(25000, 2200);   
...
////      Right_Duty(12500-Power,0);  // 12400 to 400 (negative logic)
////    }
////    WaitForTouch();
//  }
//}
